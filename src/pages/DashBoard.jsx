...
import { FaBox, FaUsers, FaArrowLeft, FaTags, FaRegCommentDots } from "react-icons/fa";
...
export default function Dashboard() {
  ...
  const { reviews = [], removeReview, loadingReviews } = useReviews(); 
    ...
    <div className="w-16 h-16 rounded-2xl bg-accent text-primary flex items-center justify-center text-2xl">
      <FaRegCommentDots />
          ...
          <div className="bg-[#181818] border border-[#2A2A2A] rounded-[32px] p-4 sm:p-6 lg:p-8 shadow-[0_20px_60px_rgba(0,0,0,0.55)] overflow-hidden">
            {tab === "overview" && (
              <div className="text-gray-400 py-4">Welcome to the central overview panel.</div>
            )}
